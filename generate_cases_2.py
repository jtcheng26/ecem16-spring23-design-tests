...
for i in range(-99, 100):
    ...
    for j in range(128):
        if random.randint(0, 63) == 0:
            ...
            if j < 48 or j > 57:
                print(f"{'0101101' if sign else '0101011'} {bitstostr(j)} {bits0} 11111111 1")
                print(f"{'0101101' if sign else '0101011'} {bits1} {bitstostr(j)} 11111111 1")
                print(f"{'0101101' if sign else '0101011'} {bitstostr(j)} {bitstostr(j)} 11111111 1")
